...
class LinkedInProvider extends AbstractProvider implements ProviderInterface
{
    ...
    protected function mapUserToObject(array $user)
    {
        ...
        $avatar = Arr::first($images, function ($image) {
            return $image['data']['com.linkedin.digitalmedia.mediaartifact.StillImage']['displaySize']['width'] === 100;
        });
        $originalAvatar = Arr::first($images, function ($image) {
            return $image['data']['com.linkedin.digitalmedia.mediaartifact.StillImage']['displaySize']['width'] === 800;
        });
